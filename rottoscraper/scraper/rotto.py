...
class Crawler:
	...
	def _add_to_result(self, base_url, rotto_links, keywords):
		"""
	...
	def _match_keyword(self, base_url, html, rotto_links):
		...
		self._add_to_result(base_url,rotto_links,matched_keys)

	def _fill_queue(self, seed_url):
		...
		if rotto_links:
			self._match_keyword(base_url, html, rotto_links)
